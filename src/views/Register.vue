<template>
    <div class="max-w-screen-sm mx-auto px-4 py-10">
        ...
        <!-- Registration  -->
        <form class="p-8 flex-col bg-light-grey rounded-md shadown-lg">
            ...
            <button type="submit" class="mt-6 py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-red duration-200 border-solid border-2 border-transparent hover:border-at-light-red hover:bg-white hover:text-at-light-red">Register</button>

            <router-link class="text-sm ml-2 text-center" :to="{name: 'Login'}">Already have an account? <span class="text-at-light-red">Login</span></router-link>
        </form>
    </div>
</template>
